...
INSERT INTO `users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `point_ext`, `deleted`) VALUES (1, 'Administrator', '', '1', 32, 1, 1, 1, '""', NULL);
INSERT INTO `users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `point_ext`, `deleted`) VALUES (2, 'Operator', '', '2', 33, 1, 0, 0, '<html><span style="font-size:26.0pt;color:blue">Floor 1<br>Office 1', NULL);
...
INSERT INTO `responses` (`id`, `name`, `text`) VALUES (1, 'Excellent', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Excellent</span></b>');
INSERT INTO `responses` (`id`, `name`, `text`) VALUES (2, 'Good', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Good</span></b>');
INSERT INTO `responses` (`id`, `name`, `text`) VALUES (3, 'So, so...', '<html><b><p align=center><span style="font-size:20.0pt;color:green">So, so...</span></b>');
INSERT INTO `responses` (`id`, `name`, `text`) VALUES (4, 'Bad', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Bad</span></b>');
INSERT INTO `responses` (`id`, `name`, `text`) VALUES (5, 'Disgusting', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Disgusting</span></b>');
