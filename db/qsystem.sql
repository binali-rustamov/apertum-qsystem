...
START TRANSACTION;
USE `qsystem`;
INSERT INTO `qsystem`.`net` (`id`, `server_port`, `web_server_port`, `client_port`, `finish_time`, `start_time`, `version`, `first_number`, `last_number`, `numering`, `point`, `sound`, `branch_id`, `sky_server_url`) VALUES (1, 3128, 8088, 3129, '18:00:00', '08:45:00', '1.2', 1, 999, 0, 0, 2, -1, '');
