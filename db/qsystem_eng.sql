...
START TRANSACTION;
USE `qsystem`;
INSERT INTO `qsystem`.`users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `point_ext`, `deleted`) VALUES (1, 'Administrator', '', '1', 32, 1, 1, 1, '\'\'', NULL);
INSERT INTO `qsystem`.`users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `point_ext`, `deleted`) VALUES (2, 'Operator', '', '2', 33, 1, 0, 0, '<html><span style=\'font-size:26.0pt;color:blue\'>Floor 1<br>Office 1', NULL);
