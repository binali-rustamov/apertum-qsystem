 ...
 * Created on 16 Апрель 2009 г., 19:26
 * Визуальный редактор параметров для редактирования параметров главных табло.
...
public class FParamsEditor extends AFBoardRedactor {
    ...
    /**
     * Получить редактор просто в виде класса для дальнейших действий с ним.
     * Singleton
