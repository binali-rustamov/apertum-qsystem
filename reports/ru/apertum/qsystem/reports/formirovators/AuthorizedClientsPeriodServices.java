...
*/
    ...
    public Response getDialog(String driverClassName, String url, String username, String password, HttpRequest request, String errorMessage) {
        ...
        result.setData(new String(result.getData()).replaceFirst("#DATA_FOR_TITLE#", "Отчет по авторизованным персонам за период для услуги:").replaceFirst("#DATA_FOR_USERS#", users_select.toString()).getBytes());
        users_select.setLength(0);
        return result;
    }
