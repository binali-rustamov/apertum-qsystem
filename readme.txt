...
(взять можно здесь http://www.oracle.com/technetwork/java/javasebusiness/downloads/java-archive-downloads-java-client-419417.html#7372-jmf-2.1.1e-oth-JPR) скопировать в папку /usr/lib/jvm/java-7-openjdk-amd64/jre/lib/ext или /usr/lib/jvm/java-7-openjdk-common/jre/lib/ext и перезапустить систему.
