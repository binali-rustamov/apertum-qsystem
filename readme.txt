...
Перед установкой системы, убедитесь, что у Вас установлена СУБД MySQL версии не ниже 5.5 и OracleJRE версии не ниже 1.7. Проверить установку JRE можно следующим способом: 
...
* Требуется использование кодировки utf8. В администраторе MySQL или в my.ini(my.cnf) укажите сообветствующие настройки. К примеру:
[mysql]
